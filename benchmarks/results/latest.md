...
- Generated: `2026-08-22T12:22:15.585147200Z`
- Runtime: Java `17.0.16` on `Windows 11 amd64`
- Result: **25/25 passed**

| ID | Area | Result | Time | Evidence |
|---|---|---:|---:|---|
|R01|ReAct|PASS|88 ms|COMPLETED in 2 rounds; tool result present|
...
|M02|Memory|PASS|18 ms|alpha sees global+alpha only|
|M03|Memory|PASS|18 ms|SQLite fact ranked first|
|M04|Memory|PASS|20 ms|fact deleted by id|
|M05|Memory|PASS|4 ms|511 -> 67 estimated tokens|
|S01|CodeSearch|PASS|392 ms|4 AST chunks indexed|
|S02|CodeSearch|PASS|21 ms|AccountService#loadAccount(String) ranked first|
|S03|CodeSearch|PASS|22 ms|AccountService CONTAINS method relation stored|
|S04|CodeSearch|PASS|26 ms|search succeeded after SQLite reopen|
|S05|CodeSearch|PASS|24 ms|AccountService symbol returned in top 3|
